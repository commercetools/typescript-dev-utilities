 ...
 *   false otherwise
 */
function isCreateAction<T>(obj: T, key: string): boolean {
  return (
 ...
 *   false otherwise
 */
function isChangeAction<T>(obj: T, key: string): boolean {
  return (
 ...
 *   false otherwise
 */
function isRemoveAction<T>(obj: T, key: string) {
  return (
 ...
 */
export default function createBuildArrayActions(key: string, config: object) {
  return function buildArrayActions<S, T extends UpdateAction>(
    diff: Delta,
    oldObj: S,
    newObj: S
  ) {
    const addActions: Array<T> = [];
    const removeActions: Array<T> = [];
    const changeActions: Array<T> = [];
