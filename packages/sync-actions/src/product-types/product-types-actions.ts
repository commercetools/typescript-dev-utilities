...
export function actionsMapBase<T extends ProductType>(
  diff: Delta,
  previous: T,
  next: T,
...
export const generateBaseFieldsUpdateActions = <T extends object>(
  previous: T,
  next: T,
...
export const actionsMapForHints = <T extends ProductType>(
  nestedValuesChanges: Delta = {},
  ptOld: T,
  ptNew: T
): Array<UpdateAction> => {
  const updateActions = [
