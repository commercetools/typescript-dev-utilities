import createSyncProductTypes from '../src/product-types/product-types';
import {
  ProductType,
    ...
    describe('with previous', () => {
      describe('with next', () => {
        ...
        describe('with changes', () => {
          ...
          it.each(changes as TemplateStringsArray)(
            'should generate update action for %s',
            (_name, expectedUpdateAction) => {
              expect(updateActions).toEqual(
