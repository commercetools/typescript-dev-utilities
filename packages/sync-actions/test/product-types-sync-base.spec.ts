...
} from '../src/product-types/product-types-actions';
import {
  ProductType,
...
describe('Actions', () => {
  let productTypesSync: SyncAction<ProductType, ProductTypeUpdateAction>;
  let updateActions: ProductTypeUpdateAction[];
  let before: Partial<ProductType>;
  let now: Partial<ProductType>;
  beforeEach(() => {
