import subscriptionsSyncFn, {
  actionGroups,
} from '../src/subscriptions/subscriptions';
import { baseActionsList } from '../src/subscriptions/subscriptions-actions';
import {
  Subscription,
...
describe('Actions', () => {
  let subscriptionsSync: SyncAction<Subscription, SubscriptionUpdateAction>;
  beforeEach(() => {
